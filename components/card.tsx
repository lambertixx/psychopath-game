...
export function Card({ id, name, image, diagnosis, isFlipped, isPsychopath, onClick }: CardProps) {
  return (
    <div className="perspective-1000 h-48 sm:h-56 md:h-64 w-full cursor-pointer" onClick={onClick}>
      <motion.div
        initial={false}
        ...
        >
          <div
            className={cn(
              ...
              isPsychopath ? "bg-red-800 text-white" : "bg-slate-600 text-slate-200",
            )}
          >
            {diagnosis}
          </div>
